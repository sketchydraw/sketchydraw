...
<!-- <div id="banner">	<div id="machelp">
		<a class="bread" href="help:anchor='access' bookID=com.SatoAkira.SketchyDraw.help">スケッチ風ドロー ヘルプ</a>
	</div>
	<div id="index">
		<a class="leftborder" href="help:anchor='x1' bookID=com.SatoAkira.SketchyDraw.help">Index</a>
	</div>
</div> -->
</body></html>